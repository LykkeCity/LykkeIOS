...
@interface LWExchangePinConfirmation () <ABPadLockScreenViewControllerDelegate> {
    ABPadLockScreenViewController *pinController;
}

@end

#warning TODO: copy-paste from LWSettingsConfirmationPresenter with small modifications
@implementation LWExchangePinConfirmation
